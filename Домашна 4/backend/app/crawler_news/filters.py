...
from crawler_news.crawler import fetch_company_news_data
from crawler_news.config import BASE_URL, COMPANIES_URL, HEADERS
from crawler_news.data_utils import save_latest_dates_to_db, load_latest_dates_from_db, append_data_to_db
...
def filter_3_fetch_missing_data(company_latest_dates):
    ...
    with Manager() as manager:
        ...
        #save_latest_dates_to_db(all_latest_dates)
        print("News Crawler - Filter 2: Completed fetching and updating news data.")
